...
export const DateSelector: React.FC<DateSelectorProps> = (props) => {
    ...
    switch (props.inputType) {
      ...
      case "week": // compare with week precision
        ...
        const lastDayOfTheWeek = new Date(
          ...
          dateTime.getMonth(),
          dateTime.getDate() - dateTime.getDay() + 6,
          0,
          0,
          0,
          0,
        ...
        setIsToday(now.getTime() > firstDayOfTheWeek.getTime() && now.getTime() < lastDayOfTheWeek.getTime());
        break;
      case "shortWeek": // compare with 3-day week precision
        const firstDayOfTheShortWeek = new Date(
          dateTime.getFullYear(),
          dateTime.getMonth(),
          dateTime.getDate(),
          0,
        ...
        const lastDayOfTheShortWeek = new Date(
          dateTime.getFullYear(),
          dateTime.getMonth(),
          dateTime.getDate() - dateTime.getDay() + 2,
          0,
          0,
          0,
          0,
        ...
        setIsToday(now.getTime() > firstDayOfTheShortWeek.getTime() && now.getTime() < lastDayOfTheShortWeek.getTime());
        break;
      case "month": // compare with month precision
        setIsToday(now.getMonth() === dateTime.getMonth() && now.getFullYear() === dateTime.getFullYear());
        break;
      default:
  ...
  const onTodayButtonClick = () => {
    if (!isToday) setDateTime(new Date(), false);
  };
  ...
  return (
    <div className={styles.root}>
      <div className={styles.dateSelector}>
        <Button
          className={mergeClasses(styles.arrowButton, styles.hideOnMobile)}
          icon={<ArrowLeftFilled />}
          onClick={() => onArrowButtonClick(-1)}></Button>
        <Button
          className={mergeClasses(styles.arrowButton, styles.hideOnMobile)}
        ...
        <Button
          ...
          icon={<CalendarTodayRegular />}></Button>
        ...
        : <Input
            ...
            onChange={(_event, data) => {
              data.value && setDateTime(new Date(data.value), false);
            }}
            value={selectorValue}></Input>
        }
      </div>
      <div className={mergeClasses(styles.dateSelector, styles.hideOnDesktop)}>
        <Button
          className={mergeClasses(styles.arrowButton, styles.growOnMobile)}
          icon={<ArrowLeftFilled />}
          onClick={() => onArrowButtonClick(-1)}></Button>
        <Button
          className={mergeClasses(styles.arrowButton, styles.growOnMobile)}
