  ...
  return (
    <>
      <TabList
        ...
        size="large"
        onTabSelect={(_, data) => {
          if (typeof data.value !== "string") throw new Error("Invalid tab value");
      ...
      <Drawer
        ...
        onOpenChange={(_, { open }) => setIsUserDrawerOpen(open)}
        position="end"
        ...
        <DrawerBody className={styles.drawerBody}>
          ...
          <div className={styles.displayColumn}>
            ...
            <Button appearance="primary" icon={<ArrowExitFilled />} onClick={() => logout()} aria-description="logout">
              Logout
            </Button>
          </div>
        </DrawerBody>
