          ...
          return (
            <div className={styles.instructions}>
              ...
              <ol className={styles.section}>
                <li>
                  <Body1>
                    Apri il menu in alto a destra <MoreVerticalRegular className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>
                ...
                <li>
                  <Body1>
                    Seleziona <b>Installa</b> nel popup
                  </Body1>
                </li>
              </ol>
          ...
          return (
            <div className={styles.instructions}>
              ...
              <ol className={styles.section}>
                <li>
                  <Body1>
                    Seleziona l'icona di condivisione <icons.browsers.safari.SquareAndArrowUp className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>Scorri verso il basso</Body1>
                </li>
                <li>
                  <Body1>
                    Seleziona <b>Aggiungi alla schermata Home</b>{" "}
                    <icons.browsers.safari.PlusApp className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>
                    Seleziona <b>Aggiungi</b> in alto a destra
                  </Body1>
                </li>
              </ol>
              ...
              <ol className={styles.section}>
                ...
                <li>
                  <Body1>
                    Seleziona <b>Aggiungi al Dock</b>{" "}
                    <icons.browsers.safari.MenubarDockRectangle className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>
          ...
          return (
            <div className={styles.instructions}>
              ...
              <ol className={styles.section}>
                <li>
                  <Body1>
                    Apri il menu in alto a destra <MoreHorizontalRegular className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>
              ...
              <ol className={styles.section}>
                <li>
                  <Body1>
                    Apri il menu in basso a destra <LineHorizontal3Regular className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>Scorri a destra</Body1>
                </li>
                <li>
                  <Body1>
                    Seleziona <b>Aggiungi al telefono</b> <PhoneAddRegular className={styles.icon} />
                  </Body1>
                </li>
              </ol>
            </div>
          ...
          return (
            <div className={styles.instructions}>
              ...
              <ol className={styles.section}>
                <li>
                  <Body1>
                    Apri il menu in basso a destra <MoreVerticalRegular className={styles.icon} />
                  </Body1>
                </li>
                <li>
                  <Body1>Scorri verso il basso</Body1>
                ...
                <li>
                  <Body1>
                    Seleziona <b>Installa</b> <icons.browsers.firefox.AddToHomeScreen className={styles.icon} />
                  </Body1>
                </li>
              </ol>
            </div>
    ...
    return (
      <>
        <TabList
          ...
          defaultSelectedValue={getBrowser()}
          appearance="transparent"
          onTabSelect={(_event, data) => {
            setBrowser(data.value as string);
          }}>
          <Tab icon={<icons.browsers.chrome.Icon />} value="chrome">
            Chrome
          </Tab>
          <Tab icon={<icons.browsers.safari.Icon />} value="safari">
            Safari
          </Tab>
          <Tab icon={<icons.browsers.edge.Icon />} value="edge">
            Edge
          </Tab>
          <Tab icon={<icons.browsers.firefox.Icon />} value="firefox">
            Firefox
          </Tab>
        </TabList>
          ...
          <DialogActions>
            ...
            <DialogTrigger>
              <Button
                ...
                appearance={shouldShowTutorial ? "primary" : "secondary"}>
                Chiudi
              </Button>
            </DialogTrigger>
          </DialogActions>
