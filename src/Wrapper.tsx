    ...
    <>
                  ...
                  containerAction={
                    <>
                      {message.isDismissable && (
                        <Button
                          onClick={() => doNotShowAgain(message.id)}
      ...
      <footer>
        <Card className={styles.footer}>
          ...
          {!pwa.isInstalled && !pwa.isPwa && (
            <Button
              className={styles.installButton}
              as="a"
              href={`web+betoniera://${window.location.href.substring(window.location.origin.length)}`}
              appearance="primary"
