      ...
      <Dialog modalType="modal" open={licenseTextVisible} onOpenChange={(_, d) => (d.open || licenseText !== undefined) && setLicenseTextVisible(d.open)}>
        <DialogSurface className={styles.licenseTextSurface}>
          <DialogBody>
            ...
            <DialogActions>
              {packageName && <RouterButton as="a" appearance="secondary" icon={<NpmIcon />} className={styles.redBackground} href={"https://www.npmjs.com/package/" + packageName.slice(0, packageName?.indexOf('@', 1))} target="_blank">Visualizza su npmjs.com</RouterButton>}
